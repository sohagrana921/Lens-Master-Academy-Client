    ...
    <div className="md:flex my-container items-center my-8">
      <div className="md:w-1/2 px-4 my-2 ">
        ...
        <p className="font-semibold my-4">
          By developing these skills, you can also begin your path to personal
          development, which can help you maximise your potential and achieve
          your career goals in record time.
        </p>
        <p>
